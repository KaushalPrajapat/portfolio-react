          ...
          <>
              ...
              <div className='h-fit w-full flex md:py-7 md:flex-row flex-col items-center justify-between max-w-7xl px-4 pt-10 md:pt-0 sm:px-10 md:px-8 md:gap-x-0 gap-x-6 xl:gap-x-10 md:mx-auto gap-y-0 md:gap-y-0'>
                <div className='w-[96%] md:w-[50%] flex flex-col gap-y-[20px] items-start sm:items-center justify-between md:items-start' data-aos="fade-up"
                  ...
                  <h1 className='text-[var(--white-primary)] font-bold tracking-[0.6px] text-[33px] sm:text-[40px] sm:text-center md:text-start md:text-[30px] lg:text-[40px] leading-[39px] md:leading-[35px] lg:leading-[40px] md:leading-[36px] lg:leading-[54px]'>
                    <GradientText style={{ fontWeight: "700px" }} tag="h1" text="Hello, I am Kaushal Prajapat," />
                    Full stack developer based in India
                  </h1>
                  <p className='text-[var(--white-primary)] text-[13.5px] font-medium tracking-wide sm:text-center md:text-start'>If your Looking for a developer who can work on both frontend and backend projects and is willing to try out new roles? or if you need a versatile and motivated developer, feel free to reach out to me.</p>
                  <div className='flex sm:gap-x-3 gap-y-3 sm:gap-y-0 flex-col sm:flex-row'>
                    ...
                    <button className='connectBTN px-6 py-3 rounded-[20px] border-[1px] border-[var(--white-secondary)] z-10 text-[var(--white-primary)] font-semibold tracking-[0.5px] text-[12px] hover:transform'><a href="https://drive.google.com/file/d/1xwwP_wd4KqjVLJ_eLVmZfTMpXnmRZd1f/view?usp=sharing" target='_blanck'>SEE MY RESUME</a></button>
                  </div>
                </div>
            ...
            <section className='mx-auto max-w-7xl pt-20 flex flex-col md:flex-row justify-start  md:items-center md:justify-between px-4 sm:px-10 md:px-8'>
              <div className='flex flex-col items-start gap-y-2 md:gap-y-3 pb-6 md:w-[30%] lg:w-[35%] xl:w-[40%] md:pb-0' data-aos="fade-up-right"
                ...
                <GradientText tag="h6" style={{ fontWeight: "700", fontSize: "18px", letterSpacing: "0.6px" }} text="Kaushal Prajapat" />
              ...
              <div className='md:w-[70%] lg:w-[60%] xl:w-[52%] flex flex-col gap-y-5' data-aos="fade-left" data-aos-duration="4000">
                <p className='text-[var(--white-primary)] text-[17px] font-semibold tracking-wide'>I am a Full Stack developer, whose passionate about developing strong and engaging web.</p>
            ...
            <section className='pt-10 md:mx-auto max-w-7xl px-4 sm:px-10 md:px-8 flex flex-col justify-center' id='education' >
              ...
              <div className='grid gap-y-4 grid-cols-1 md:grid-cols-2 gap-x-4'>
                <EducationCard duration="2018-2022" type="Graduation" degree="Bachelor's Degree" degreeType="B-Tech" course="Computer Science Engineering" schoolName="Gurukul Kangari University" schoolLocation="Haridwar, Uttarakhand India" cardType={1} />
                <EducationCard duration="2016-2027" type="High School" degree="Intermediate" course="Science (MPC)" schoolName="DS science Academy" schoolLocation="Gangapur City, Rajasthan, India" cardType={2} />
              </div>
            </section>
            ...
            <section className='md:mx-auto max-w-7xl pt-20 px-4 sm:px-10 md:px-8' id='projects'>
              ...
              <div className='flex items-center justify-center w-full mt-8'>
                <button className='bg-[#feb901] transition ease duration-400 text-[#000] py-4 px-7 rounded-[30px] hover:bg-[#d39f0f]'><a className='flex items-center justify-center gap-x-2 text-[19px] font-bold' target='_blanck' href='https://github.com/KaushalPrajapat'><FaGithub className='text-[25px]' /> See Github</a></button>
              </div>
            </section>
            <Contact />
            <TopArrow />
